...
function changeQuestStatus(index) {
  ...
  if (box.checked) {
    ...
    pctLabel.textContent = `${(dailyQuestExp[index] / levelUpExp[parseInt(inputLevel.value)] * 100).toFixed(3)}%`;
...
function updateExpDisplay() {
  ...
  var totalExpPercet = (totalExpNumber / levelUpExp[parseInt(inputLevel.value)] * 100).toFixed(3);
